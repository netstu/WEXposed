		...
		try {
			...
			XposedBridge.hookAllMethods(cResolver, "query", new XC_MethodHook() {
				...
				protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
					// XposedBridge.log("==>Hooked package: " +
					// param.getClass().getPackage());
			...
			final Class<?> db = findClass("android.database.sqlite.SQLiteQueryBuilder", lpparam.classLoader);
			...
			final Class<?> cLoader = findClass("android.content.CursorLoader", lpparam.classLoader);
